...
export default function RNavBar(props) {
  ...
  const variants = [
    ...
    },
    {
      overrides: {
        ...
        Applicants: {},
        Company: {},
        "Frame 32134562971": { width: "153.5px", basis: "153.5px" },
        SearchField: { width: "135px", height: "48px" },
        Vector: {},
        Icon: {},
        image: {},
        "Frame 32134562976": {
  ...
  return (
    <Flex
      ...
      {...rest}
      {...getOverrideProps(overrides, "RNavBar")}
    >
      <Flex
        gap="2px"
        width="fit-content"
        ...
        {...getOverrideProps(overrides, "Logo34562968")}
      >
        <Icon
          width="18px"
          height="18px"
        ...
        <Text
          ...
          whiteSpace="pre-wrap"
          children="Logo"
          {...getOverrideProps(overrides, "Logo34562970")}
        ></Text>
      </Flex>
      <Flex
        gap="40px"
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Frame 32134562971")}
      >
        <Text
          fontFamily="Inter"
          fontSize="16px"
      ...
      <Flex
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Frame 32134562976")}
      >
        <Flex
          gap="8px"
          direction="column"
